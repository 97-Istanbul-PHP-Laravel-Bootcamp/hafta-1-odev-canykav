				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<?php if(isset($_SESSION['user'])!="") { ?> <li><a href="/account"><i class="fa fa-user"></i>Hesap</a></li> <?php } ?>
								<?php if(isset($_SESSION['user'])!="") { ?> <li><a href="/checkout"><i class="fa fa-crosshairs"></i> Kasaya Git</a></li> <?php } ?>
								<li><a href="cart"><i class="fa fa-shopping-cart"></i> Sepet</a></li>
								<?php if(empty($_SESSION['user'])) { ?> <li><a href="/login"><i class="fa fa-lock"></i> Giriş</a></li>' <?php } ?>
							</ul>
						</div>
					</div>
				</div>
